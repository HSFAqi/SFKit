...
extension String {
    ...
    func evaluateWithRegex(_ regex: String) -> Bool{
    ...
    /// 匹配中文
    func isChinese() -> Bool {
        return self.evaluateWithRegex("^[\\u4e00-\\u9fa5]{0,}$")
    }
    
    /// 英文字母
    func isEnglish() -> Bool {
        return self.evaluateWithRegex("^[a-zA-Z]*$")
    }
    
    /// 数字:[0-9]
    func isNumber() -> Bool {
        return self.evaluateWithRegex("^[0-9]*$")
    }
    
    /// 匹配Email地址
    func isEmail() -> Bool {
        return self.evaluateWithRegex("^[a-zA-Z0-9][\\w\\.-]*[a-zA-Z0-9]@[a-zA-Z0-9][\\w\\.-]*[a-zA-Z0-9]\\.[a-zA-Z][a-zA-Z\\.]*[a-zA-Z]$")
    }
    
    /// 手机号
    func isPhoneNumber() -> Bool {
        return self.evaluateWithRegex("^((13[0-9])|(14[0-9])|(15[0-9])|(17[0-9])|(18[0-9]))\\d{8}$")
    }
    
    /// 密码（匹配由数字、26个英文字母或者下划线组成的字符串）
    func isPassward() -> Bool {
        return self.evaluateWithRegex("^w+$")
    }
    
    /// 身份证
    func isIdentityNumber() -> Bool {
        return self.evaluateWithRegex("(^\\d{15}$)|(^\\d{17}([0-9]|X|x)$)")
    }
